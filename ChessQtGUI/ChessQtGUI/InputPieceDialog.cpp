...
InputPieceDialog::InputPieceDialog(Color color, ChessBoard* chessBoardPtr,
                                   QWidget *parent) :
    QDialog(parent),
...
{
    this->output = new Knight(this->color, this->chessBoardPtr);
    this->close();
}

void InputPieceDialog::on_bishopButton_clicked()
{
    this->output = new Bishop(this->color, this->chessBoardPtr);
    this->close();
}

void InputPieceDialog::on_rookButton_clicked()
{
    this->output = new Rook(this->color, this->chessBoardPtr);
    this->close();
}

void InputPieceDialog::on_queenButton_clicked()
{
    this->output = new Queen(this->color, this->chessBoardPtr);
    this->close();
}
